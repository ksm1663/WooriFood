...
//            String uploadUser = reviewSet.getUser().getUser_name();
        ...
        detailImageViewAdapter = new DetailImageViewAdapter(userImages, context);
...
//        if (((MainActivity)context).getSupportFragmentManager().getFragments().get(0) instanceof MyReviewFragment){
//            ((ReviewItemHolder) holder).textReviewerStr.setVisibility(View.GONE);
//        } else {
//            ((ReviewItemHolder) holder).textReviewerStr.setVisibility(View.VISIBLE);
//        }
        ...
        if (complex == Code.ComplexType.COZY)
            ...
            ((ReviewAdapter.ReviewItemHolder) holder).getRadioComplex().setText("무난");
